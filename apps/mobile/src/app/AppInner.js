...
import {SafeAreaView,View,Text,TextInput,TouchableOpacity,ScrollView,Alert,AppState} from 'react-native';
import {RNFS,Share,XLSX,secureGetItem,secureSetItem,encryptBackupPayload,decryptBackupPayload,isBiometrySupported,enableBiometricUnlock,disableBiometricUnlock} from '../services/index.js';
import {defaultCategories,paymentMethods,avatarChoices,defaultProfile,emptyExpenses,formatINR,total,monthNames,toExpenseRows,isIncomeCategory,buildBackupPayload,parseBackupPayload,isEncryptedBackupText,defaultAppLock,isValidPin,recurringFrequencies,frequencyLabels,generateDueExpenses,computeQuickAddSuggestions,computeStreaks,computePeriodComparison,normalizeImportedRows} from '../../../../packages/core/src/index.js';
import {Home,ListChecks,Plus,PieChart,Target,Tags,User,X,Download,Upload} from 'lucide-react-native';
