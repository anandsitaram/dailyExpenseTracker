import { Category, Expense, RecurringExpense, Profile, RecurringTemplate } from './types.js';
...
export function parseBackupPayload(text: string) {
  ...
  return {
    ...
    recurring: Array.isArray(data.recurring) ? (data.recurring as RecurringExpense[]) : [],
    profile:
