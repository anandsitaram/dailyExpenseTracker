...
export const isIncomeCategory = (categories, id) =>
...
export function buildCalendarGrid(y, m) {
  ...
  while (cells.length % 7 !== 0 || cells.length < 42)
    cells.push({ day: cells.length - lead - total + 1, y: nextYear, m: nextMonth, inMonth: false });
  return cells;
}

// --- excel export helper ---
export const toExpenseRows = (expenses, categories) =>
  expenses.map((e) => ({
    Date: e.date,
